      ...
      <div className="container px-5 pt-20 mx-auto">
        <div className="flex flex-col text-center w-full mb-10">
          ...
          <p className="lg:w-2/3 mx-auto leading-relaxed text-base">
            ...
            dedication to excellence in construction and design.
          </p>
        </div>
        <div className="flex items-end justify-end mb-3 text-[#0184a2] px-2 ">
          <Link to="/gallery" className="border-b-2 border-[#0184a2]">
            see all
          </Link>
        </div>
